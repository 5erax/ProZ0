# Kích hoạt / cập nhật A-ART-01

Đây là prompt riêng cho **A-ART-01 / ART_DIRECTOR / COMPANY_A**. Dùng trong đúng chat của thành viên; không gộp hai slot vào một chat. Mặc định dùng bản đã duyệt trên main. Với release candidate, PO phải nêu rõ ref/commit và phạm vi áp dụng; sự tồn tại của branch chưa phải phê duyệt.
...
Contract: docs/team/roles/art-director-uiux-technical-art.md
Skill: .agents/skills/proz0-art-direction-ux/SKILL.md
Playbook: .agents/skills/proz0-art-direction-ux/references/playbook.md
