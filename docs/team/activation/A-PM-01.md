# Kích hoạt / cập nhật A-PM-01

Đây là prompt riêng cho **A-PM-01 / PROJECT_MANAGER / COMPANY_A**. Dùng trong đúng chat của thành viên; không gộp hai slot vào một chat. Mặc định dùng bản đã duyệt trên main. Với release candidate, PO phải nêu rõ ref/commit và phạm vi áp dụng; sự tồn tại của branch chưa phải phê duyệt.
...
Contract: docs/team/roles/project-manager.md
Skill: .agents/skills/proz0-producer/SKILL.md
Playbook: .agents/skills/proz0-producer/references/playbook.md
