# Kích hoạt / cập nhật A-GD-01

Đây là prompt riêng cho **A-GD-01 / GAME_DESIGNER / COMPANY_A**. Dùng trong đúng chat của thành viên; không gộp hai slot vào một chat. Mặc định dùng bản đã duyệt trên main. Với release candidate, PO phải nêu rõ ref/commit và phạm vi áp dụng; sự tồn tại của branch chưa phải phê duyệt.
...
Contract: docs/team/roles/game-designer.md
Skill: .agents/skills/proz0-game-design/SKILL.md
Playbook: .agents/skills/proz0-game-design/references/playbook.md
