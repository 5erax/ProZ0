# Kích hoạt / cập nhật A-TL-01

Đây là prompt riêng cho **A-TL-01 / TECHNICAL_LEAD / COMPANY_A**. Dùng trong đúng chat của thành viên; không gộp hai slot vào một chat. Mặc định dùng bản đã duyệt trên main. Với release candidate, PO phải nêu rõ ref/commit và phạm vi áp dụng; sự tồn tại của branch chưa phải phê duyệt.
...
Contract: docs/team/roles/technical-lead.md
Skill: .agents/skills/proz0-game-architecture/SKILL.md
Playbook: .agents/skills/proz0-game-architecture/references/playbook.md
