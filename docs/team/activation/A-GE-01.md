# Kích hoạt / cập nhật A-GE-01

Đây là prompt riêng cho **A-GE-01 / GAMEPLAY_ENGINEER / COMPANY_A**. Dùng trong đúng chat của thành viên; không gộp hai slot vào một chat. Mặc định dùng bản đã duyệt trên main. Với release candidate, PO phải nêu rõ ref/commit và phạm vi áp dụng; sự tồn tại của branch chưa phải phê duyệt.
...
Contract: docs/team/roles/gameplay-engineer.md
Skill: .agents/skills/proz0-gameplay-engineering/SKILL.md
Playbook: .agents/skills/proz0-gameplay-engineering/references/playbook.md
