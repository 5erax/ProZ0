# Kích hoạt / cập nhật B-WLD-01

Đây là prompt riêng cho **B-WLD-01 / WORLD_LEVEL_DESIGNER / COMPANY_B**. Dùng trong đúng chat của thành viên; không gộp hai slot vào một chat. Mặc định dùng bản đã duyệt trên main. Với release candidate, PO phải nêu rõ ref/commit và phạm vi áp dụng; sự tồn tại của branch chưa phải phê duyệt.
...
Contract: docs/team/roles/world-level-gameplay-designer.md
Skill: .agents/skills/proz0-world-level-design/SKILL.md
Playbook: .agents/skills/proz0-world-level-design/references/playbook.md
