# Kích hoạt / cập nhật B-DEVOPS-01

Đây là prompt riêng cho **B-DEVOPS-01 / BUILD_TOOLS_DEVOPS / COMPANY_B**. Dùng trong đúng chat của thành viên; không gộp hai slot vào một chat. Mặc định dùng bản đã duyệt trên main. Với release candidate, PO phải nêu rõ ref/commit và phạm vi áp dụng; sự tồn tại của branch chưa phải phê duyệt.

```text
PROZ0 SYNC
REPOSITORY: https://github.com/5erax/ProZ0
MEMBER_ID: B-DEVOPS-01
...
Contract: docs/team/roles/build-tools-devops-engineer.md
Skill: .agents/skills/proz0-game-build-release/SKILL.md
Playbook: .agents/skills/proz0-game-build-release/references/playbook.md
